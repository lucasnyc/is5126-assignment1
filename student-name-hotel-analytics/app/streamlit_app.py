...
show_pages = {
    ...
    "Intelligent Analytics Platform":[
        st.Page(PROJECT_ROOT / "app" / "pages" / "Intelligent_Analytics_Platform" / "Guest_Experience_Dashboard.py", title="My Guest Experience Dashboard", icon="🧠"),
        st.Page(PROJECT_ROOT / "app" / "pages" / "Intelligent_Analytics_Platform" / "Market_Position_Dashboard.py", title="Market Position Dashboard", icon="🧠"),
        st.Page(PROJECT_ROOT / "app" / "pages" / "Intelligent_Analytics_Platform" / "Improvement_Plan_by_LLM.py", title="Improvement Plan Dashboard", icon="🧠"),
        st.Page(PROJECT_ROOT / "app" / "pages" / "Intelligent_Analytics_Platform" / "Investment_Return_Prediction.py", title="Investment Return Prediction Dashboard", icon="🧠"),
